...
<div class="iq-navbar-header " style="height: 215px;">
    ...
    <div class="iq-header-img">
        <img src="<?php echo esc_url( GRAVITYFORMS_FLUTTERWAVE_ADDONS_BUILD_URI . '/img/top-header.png' ); ?>" alt="header" class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
    </div>
</div>