	...
	return (
		<div className="aquila-icon-heading">
			...
			<RichText
				...
				placeholder={ __( 'Heading…', 'fwp-Listivo-child-c4trade' ) } // Display this text before any content has been added by the user
			/>
			<InspectorControls>
				<PanelBody title={ __( 'Block Settings', 'fwp-Listivo-child-c4trade' ) }>
					<RadioControl
						label={ __( 'Select the icon', 'fwp-Listivo-child-c4trade' ) }
						help={ __( 'Controls icon selection', 'fwp-Listivo-child-c4trade' ) }
						selected={ option }
						options={ [
							{ label: 'Dos', value: 'dos' },
